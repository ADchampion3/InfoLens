...
const key = command === "hackernews top" ? "hn" : command === "github-trending repos" ? "github" : command === "infolens-github readme" ? "readme" : "unknown";
...
else if (key === "readme") process.stdout.write(JSON.stringify([{ repositoryId: process.argv[4], html: "<article><h1>Fixture README</h1></article>", sourceUrl: `https://github.com/${process.argv[4]}#readme` }]));
