...
import { openStore as openHnStore } from "../plugins/hn/backend/history-storage.js";
import { openStore as openGithubStore } from "../plugins/github-trending/backend/history-storage.js";
