...
test("Bundled Plugin export routes serve all four formats with fixed transport headers", async () => {
  ...
  const stores = [
    ...
    ["juejin", "juejin.sqlite", openJuejin, { id: "1234567890123456789", category: "backend", rank: 1, title: "Article", brief: "Brief", author: "author", views: 10, likes: 2, comments: 1, hotRank: 5, url: "https://juejin.cn/post/1234567890123456789" }, "1234567890123456789"],
