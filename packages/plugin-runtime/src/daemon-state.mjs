...
export function daemonPaths(root = defaultDaemonDataRoot(), environment = process.env) {
  ...
  return Object.freeze({
    ...
    distributionJournalRoot: resolved(environment.INFOLENS_DISTRIBUTION_JOURNAL_ROOT || path.join(dataRoot, "plugin-distribution", "journals")),
    distributionRevisionRoot: resolved(environment.INFOLENS_DISTRIBUTION_REVISION_ROOT || path.join(dataRoot, "plugin-distribution", "revisions")),
